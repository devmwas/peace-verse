  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 py-12 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Intro */}
        <motion.p
          className="text-lg text-center text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.3, duration: 0.8 }}
        >
          At <span className="font-semibold text-white">Team Ubantu</span>, we
          believe in the power of technology, collaboration, and community to
          drive meaningful change. We are the creative minds behind{" "}
          <span className="font-semibold text-indigo-400">Amani360.org</span>, a
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-shadow p-6 text-center">
              <Users className="w-10 h-10 mx-auto text-indigo-400 mb-4" />
              <h2 className="text-xl font-semibold mb-2">Our Journey</h2>
              <p className="text-gray-400 text-sm leading-relaxed">
                We began at the{" "}
                <span className="font-medium">
                  1st Youth Civic Tech Hackathon
                </span>{" "}
          ...
          >
            <div className="bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-shadow p-6 text-center">
              <Globe2 className="w-10 h-10 mx-auto text-indigo-400 mb-4" />
        ...
        {/* Closing Note */}
        <motion.p
          className="text-center text-gray-400 mt-12 text-lg font-medium"
          initial={{ opacity: 0 }}
